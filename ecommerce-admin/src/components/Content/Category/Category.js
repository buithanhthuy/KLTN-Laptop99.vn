      ...
      <div className="content-inner">
        ...
        <header className="page-header">
          <div className="container-fluid">
            <h2 className="no-margin-bottom">Nhóm hàng</h2>
          </div>
        </header>
        {/* Breadcrumb*/}
        <div className="breadcrumb-holder container-fluid">
          <ul className="breadcrumb">
            <li className="breadcrumb-item"><Link to="/">Kho hàng</Link></li>
            <li className="breadcrumb-item active">Nhóm hàng</li>
          </ul>
        </div>
                  ...
                  <form onSubmit={(event) => this.handleSubmit(event)}
                    ...
                    <div>
                      ...
                      <input
                        ...
                        value={searchText}
                        className="form-control form-control-sm ml-3 w-75" type="text" placeholder="Tìm nhóm hàng ..."
                        aria-label="Search" />
                    </div>
                      ...
                      <table className="table table-hover">
                        <thead>
                          <tr>
                            ...
                            <th style={{ textAlign: "center" }}>Tác động</th>
                          </tr>
                        </thead>
                        <tbody>
