      ...
      <div className="content-inner">
        ...
        <header className="page-header">
          <div className="container-fluid">
            <h2 className="no-margin-bottom">Kiểm soát kho hàng</h2>
          </div>
        </header>
        ...
        <section className="dashboard-counts no-padding-bottom">
          <div className="container-fluid">
            <div className="row bg-white has-shadow">
              ...
              <div className="col-xl-3 col-sm-6">
                <div className="item d-flex align-items-center">
                  ...
                  <div className="title"><span>Người dùng mới</span>
              ...
              <div className="col-xl-3 col-sm-6">
                <div className="item d-flex align-items-center">
                  ...
                  <div className="title"><span>Sản phẩm mới</span>
                    <div className="progress">
              ...
              <div className="col-xl-3 col-sm-6">
                <div className="item d-flex align-items-center">
                  ...
                  <div className="title"><span>Tổng thu nhập<br/></span>
                    <div className="progress">
            ...
            <h3 style={{paddingTop: 20}}>Báo cáo danh mục các sản phẩm</h3>
            <Pie 
              width={100}
