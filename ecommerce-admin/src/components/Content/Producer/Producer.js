...
class Producer extends Component {
  ...
  handleRemove = (id) => {
    MySwal.fire({
      ...
      text: "Bạn không thể giữ lại nhà cung cấp trước đó!",
      icon: 'warning',
              ...
              <div className="col-lg-12">
                <div className="card">
                  ...
                  <form onSubmit={(event) => this.handleSubmit(event)}
                    ...
                    <Link to="/producers/add" className="btn btn-primary" > Thêm mới nhà cung cấp </Link>
                  </form>
                      ...
                      <table className="table table-hover">
                        <thead>
                          <tr>
                            ...
                            <th>Ảnh</th>
                            <th>Nhóm hàng</th>
                            <th style={{ textAlign: "center" }}>Đang cung cấp</th>
