            ...
            <div className="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <div className="navbar-header">
                {/* Navbar Brand */}<Link to="/" className="navbar-brand d-none d-sm-inline-block">
                  <div className="brand-text d-none d-lg-inline-block"><strong>Admin Laptop99.vn</strong></div></Link>
              </div>
              {/* Navbar Menu */}
              <ul className="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                  ...
                  <ul aria-labelledby="notifications" className="dropdown-menu">
                    <li><Link rel="nofollow" to="#" className="dropdown-item">
                      <div className="notification">
                        <div className="notification-content"><i className="fa fa-envelope bg-green" />Bạn có 6 tin nhắn mới </div>
                        <div className="notification-time"><small>4 phút trước</small></div>
                      </div></Link></li>
                    <li><Link rel="nofollow" to="#" className="dropdown-item all-notifications text-center"> <strong>Xem toàn bộ thông báo</strong></Link></li>
                  </ul>
                </li>
                {/* Languages dropdown    */}
                <li className="nav-item dropdown"><a id="languages" rel="nofollow" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" className="nav-link language dropdown-toggle"><img src="https://i.ibb.co/QrtCN5s/GB.png" alt="English" /><span className="d-none d-sm-inline-block">English</span></a>
                  <ul aria-labelledby="languages" className="dropdown-menu">
                    ...
                    <li><Link rel="nofollow" to="#" className="dropdown-item"> <img src="https://i.ibb.co/SnpwbfX/VN.png" alt="English" className="mr-2" />Việt Nam </Link></li>
                  </ul>
                </li>
                {/* Logout    */}
