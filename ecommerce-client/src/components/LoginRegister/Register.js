          ...
          <div className="login-form">
            ...
            <div className="row">
              <div className="col-md-12 mb-20">
                <label>Tên </label>
                <input onChange={this.handleChange} value={name} className="mb-0" type="text" name="name" placeholder="Tên" />
              </div>
              <div className="col-md-12 mb-20">
                <label>Địa chỉ Email*</label>
                <input onChange={this.handleChange} value={email} className="mb-0" type="email" name="email" placeholder="Email" />
              </div>
              ...
              <div className="col-md-6 mb-20">
                ...
                <input onChange={this.handleChange} className="mb-0" type="password" name="repassword" placeholder="xác thực" />
              </div>
